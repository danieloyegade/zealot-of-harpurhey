...
- Project title: **Zealot of Harpurhey**.
...
Fashion is a primary component of Zealot of Harpurhey's visual identity, not incidental character decoration.
...
Every significant character and many background NPCs should have deliberately curated outfits. The population of Harpurhey should feel like a photographed and styled cast.
...
The goal is for Harpurhey's population to look authored by a fashion photographer rather than generated by a conventional NPC system.
...
Photography and filmmaking equipment should physically appear within Harpurhey. Potential recurring objects:
...
## Harpurhey ↔ The Promised Land Bus Route
