...
The game opens on a single reproduced textile-and-silver plate: `public/ui/title/zealot-loading-screen.png` (1672 × 941). It owns the title, the knight/courier joust, the border, the TSAU mark and the authorship credit. Browser UI does not reconstruct or add to that composition.
...
| Source artwork used in game | `public/ui/title/zealot-loading-screen.png` |
