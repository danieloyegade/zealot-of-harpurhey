...
- `blender/source/textures/florist/harpurhey-florist-facade.jpg` — 512 × 768
- `blender/source/textures/florist/harpurhey-florist-shopfront.jpg` — 512 × 384

Both are embedded in `public/assets/models/harpurhey-florist.glb` during export. The primary crop isolates the central façade; the secondary crop preserves more shopfront signage and window content at pedestrian distance.
